...
class Document():
    def __init__(self):
        ...
        alphabetModel_path = self.path + 'Models/SeperateModel/Alphabets_v3.h5'
        digitModel_path = self.path + 'Models/SeperateModel/Digit_v2.h5'
        atr_Model_path = self.path + 'Models/SeperateModel/@.h5'
        _modelpath = self.path + 'Models/SeperateModel/_model.h5'
